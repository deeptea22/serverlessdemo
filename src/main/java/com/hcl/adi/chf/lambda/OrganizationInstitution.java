 ...
 * @author AyushRa
 */
public final class OrganizationInstitution implements RequestHandler<Institution, CustomResponse> {
	private static final Logger LOGGER = LogManager.getLogger(OrganizationInstitution.class.getName());
